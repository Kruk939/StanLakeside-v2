...
if("_type" isEqualTo "") exitWith {diag_log "fn_updateMayorATM.sqf: _type empty (2)";}; 
...
//if(mayorBank isEqualTo "") exitWith {diag_log "ERROR: Can't update mayorBank! Check code! (maybe null mayorBank?) (fn_updatemayorBank.sqf)";};
