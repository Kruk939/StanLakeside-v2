/*
		...
		Return: nothing
*/
private["_id_company","_level","_query","_data","_id_vehicle","_Vtype","_license"];
...
if(_type == "avialable") exitWith {
	...
	_Vtype = _data select 2;
	_query= format["company_garage_getVehicles:%1:%2:%3", _id_company, 0, _Vtype, _level];
