...
CREATE TABLE `log_action` (
  ...
  `playerItems` varchar(1500) NOT NULL,
  `playerClothes` varchar(1500) NOT NULL,
  `playerWeapons` varchar(1500) NOT NULL,
  ...
  `unitItems` varchar(1500) NOT NULL,
  `unitClothes` varchar(1500) NOT NULL,
  `unitWeapons` varchar(1500) NOT NULL,
  PRIMARY KEY (`ID`)
