_menuItems = [
	...
	[
		...
		["Załóż worek", " ['Zakładanie worka',5,ClientModules_PTP_fnc_blindfold,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn ClientModules_doTask_fnc_dotask ",2]
	],

	[
		["isPlayer cursorObject", "!imRestrained", "(headgear CurrentCursorTarget) == 'mgsr_headbag' "],
		["Zdejmij worek", " ['Zdejmowanie worka',5,ClientModules_PTP_fnc_unblindfold,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn ClientModules_doTask_fnc_dotask",2]
	],
