class GUN_Menu {
	idd = 9999;
	name= "GUN_menu";
	onLoad = "[] spawn ClientModules_StoreSystem_fnc_storesetup";
	...
	class controls {
		...
		class ShopList : client_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.05;
			onLBSelChanged = "[] spawn ClientModules_StoreSystem_fnc_clothesUpdate;";
		...
		class gunOption : HideButton {
			idc = 9993;
			text = "";
			onButtonClick = "[""gunstore""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;";
		...
		class vestOption : HideButton {
			idc = 9994;
			text = "";
			onButtonClick = "[""veststore""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;"; 
			x = 0.311029 * safezoneW + safezoneX;
		...
		class PurchaseOption : HideButton {
			idc = 9995;
			text = "Kup";
			onButtonClick = "[""standard""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;";
...
class RareFish_Menu {
	...
	class controls {
		...
		class PurchaseOption : HideButton {
			idc = 9995;
			text = "Kup";
			onButtonClick = "[""fish""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;"; 
			x = 0.40229 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.023 * safezoneH;
...
class Clothing_Menu {
	...
	class controls {
		...
		class ClothingOption : HideButton {
			idc = 9993;
			text = "Clothing";
			onButtonClick = "[""clothing""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
		...
		class BackpackOption : HideButton {
			idc = 9994;
			text = "Backpack";
			onButtonClick = "[""backpack""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.729497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
...
class HairDresser_Menu {
	...
	class controls {
		...
		class ClothingOption : HideButton {
			idc = 9993;
			text = "Glasses";
			onButtonClick = "[""Glasses""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
		...
		class BackpackOption : HideButton {
			idc = 9994;
			text = "Head";
			onButtonClick = "[""head""] spawn ClientModules_StoreSystem_fnc_confirmPurchase;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.729497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
