...
if (_amount > 0) then {
	[_amount, 1] call ClientModules_ATM_fnc_atmRefresh;
	[player, player getVariable "bankAccount", _amount, 1] remoteExecCall ["ServerModules_ATM_fnc_atmReplicateMoney", 2];
} else {
