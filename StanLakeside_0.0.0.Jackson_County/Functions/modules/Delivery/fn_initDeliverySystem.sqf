...
_menuItems = [
	[
		...
		["Tasks", "[] call ClientModules_fnc_openTakeDelivery",1]
	],
	[
		...
		["Take Items", "[] call ClientModules_fnc_openTakeDeliveryItem",1]
	],
	[
		...
		["Deliver", "[] call ClientModules_fnc_openDeliverDelivery",1]
	]
];
{
