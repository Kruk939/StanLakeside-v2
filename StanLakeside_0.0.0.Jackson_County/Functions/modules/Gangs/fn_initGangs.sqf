gangList = ["76561198061433788"]; // lista LIDERÓW gangów
...
_check = [getPlayerUID player] call ClientModules_Gangs_fnc_checkGang;
if (_check) then {
_menuItems = [
    [
        ["alive player"],
        ["Losowy pistolet", "[] call ClientModules_Gangs_fnc_randWeapon", 3]
    ]
];
    {
