...
////////////////////////////////////////////////////////
		...
		class RscListbox_1500: RscListbox
		{
			...
			font = "PuristaMedium";
			sizeEx = 0.030;
			onLBSelChanged = "[] call ClientModules_Phone_fnc_onLBDarknetChangeMessage;";
...
////////////////////////////////////////////////////////
		...
		class RscButton_1601: RscButtonInv
		{
			...
			action = "[] call ClientModules_Phone_fnc_openWritingDarknetMessage;";
			x = 21.5 * GUI_GRID_W + GUI_GRID_X;
			y = 14 * GUI_GRID_H + GUI_GRID_Y;
			w = 2.5 * GUI_GRID_W;
			h = 2 * GUI_GRID_H;
