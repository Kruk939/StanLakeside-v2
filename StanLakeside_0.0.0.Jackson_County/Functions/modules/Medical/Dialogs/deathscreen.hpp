class medical_deathScreen
{
	idd = 100002;
	name = "medical_deathScreen";
	movingEnabled = 0;
	onload = "_MedicBtn = ((findDisplay 100002) displayCtrl 7303);_MedicBtn ctrlEnable true;";
	enableSimulation = 1;
	...
	class Controls {
		...
		class MedicBtn : client_RscButtonMenu {
			...
			h = 0.0461907 * safezoneH;
			onButtonClick = "[player] remoteExec [""server_fnc_requestMedic"",2]; _MedicBtn = ((findDisplay 100002) displayCtrl 7303); _MedicBtn ctrlEnable false; ";
			text = "Request Medic";
			colorBackground[] = {0, 0, 0, 1};
			class Attributes
			{
