...
if (_smokeColor == 1) then {
	[curMethLab, [0.02,0.302,0], (25+random 5)] remoteExec ["ClientModules_methLab_fnc_methSmoke", 0];
} else {
	[curMethLab, [0.439,0,0.075], (25+random 5)] remoteExec ["ClientModules_methLab_fnc_methSmoke", 0];
};
