class ATMmafia
{
	...
	class controls 
	{
		...
		class RscButton_1600: HideButton
		{
			...
			w = 0.09875 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [] call ClientModules_ATM_Mafia_fnc_atmWithdraw;
		};
		class RscButton_1601: HideButton
		{
			...
			w = 0.09875 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = [] call ClientModules_ATM_Mafia_fnc_atmDeposit;
		};
		...
		class RscButton_1602: HideButton
		{
			...
			w = 0.09875 * safezoneW;
			h = 0.0329871 * safezoneH;
			action = "hint ""Transfery wyłączone w bankomacie mafii"";";
		};
