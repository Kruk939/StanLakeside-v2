class kruk_slpd_computer {
	...
	class controls {
		...
		class button_search_plate: client_RscButtonMenu {
			idc = 1201;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_SEARCHPLATE;
			x = 21 * GUI_GRID_W + GUI_GRID_X;
		...
		class button_search_name: client_RscButtonMenu {
			idc = 1202;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_SEARCHNAME;
			x = 21 * GUI_GRID_W + GUI_GRID_X;
		...
		class button_search_uid: client_RscButtonMenu {
			idc = 1202;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_IDNR;
		...
		class button_close: client_RscButtonMenu {
		    ...
		    sizeEx = 0.02921;
			style = 2;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_CLOSE;
		...
		class button_search_case: client_RscButtonMenu {
			idc = 1204;
		    sizeEx = 0.02921;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_CASESPERSON;
			x = 21 * GUI_GRID_W + GUI_GRID_X;
		...
		class button_search_case_vehicle: client_RscButtonMenu {
			idc = 1212;
		    sizeEx = 0.02921;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_CASESVEH;
			x = 21 * GUI_GRID_W + GUI_GRID_X;
		...
		class button_vehicle_check: client_RscButtonMenu {
			idc = 1205;
		    sizeEx = 0.02921;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_CHECK;
			style = 2;
		...
		class button_criminal_add: client_RscButtonMenu {
			idc = 1207;
		    sizeEx = 0.02921;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_ADD;
			style = 2;
			x = 31 * GUI_GRID_W + GUI_GRID_X;
			y = 10 * GUI_GRID_H + GUI_GRID_Y;
			w = 4.5 * GUI_GRID_W;
		...
		class button_change: client_RscButtonMenu {
			idc = 1209;
		    sizeEx = 0.02921;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_CHANGE;
			style = 2;
		...
		class button_case_check: client_RscButtonMenu {
			idc = 1210;
		    sizeEx = 0.02921;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_PREVIEWCASE;
			style = 2;
			x = 11 * GUI_GRID_W + GUI_GRID_X;
			y = 10 * GUI_GRID_H + GUI_GRID_Y;
			w = 9.0 * GUI_GRID_W;
		...
		class button_refresh: client_RscButtonMenu {
		    ...
		    sizeEx = 0.02921;
			style = 2;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_REFRESH;
			x = 21 * GUI_GRID_W + GUI_GRID_X;
			y = 21.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 9 * GUI_GRID_W;
			h = 1.5 * GUI_GRID_H;
		...
		class text_title: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_COMPUTER;
			x = 0 * GUI_GRID_W + GUI_GRID_X;
		...
		class text_wanted_criminals: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_WANTEDCRIMINALS;
			x = 0 * GUI_GRID_W + GUI_GRID_X;
		...
		class text_search: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_SEARCH;
			x = 21 * GUI_GRID_W + GUI_GRID_X;
			y = 1.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 19 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		class text_wanted_vehicles: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_WANTEDVEHICLES;
			x = 0 * GUI_GRID_W + GUI_GRID_X;
			y = 12 * GUI_GRID_H + GUI_GRID_Y;
			w = 20 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		class text_search_input: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_SEARCHINPUT;
			x = 21 * GUI_GRID_W + GUI_GRID_X;
			y = 12 * GUI_GRID_H + GUI_GRID_Y;
			w = 19 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
...
class kruk_slpd_casefile {
	...
	class controls {
		...
		class button_close: client_RscButtonMenu {
		    ...
		    sizeEx = 0.02921;
			colorBackground[] = {0.7,0,0,0.5};
			text = $STR_RPF_MODULES_SLPDCOMPUTER_RETURN;
		...
		class text_title: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_ARCHIVE;
			x = 0 * GUI_GRID_W + GUI_GRID_X;
			y = 0 * GUI_GRID_H + GUI_GRID_Y;
			w = 40 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		class text_info: RscText {
			...
			style = 16;
		    sizeEx = 0.035;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_INFORMATION;
			x = 0 * GUI_GRID_W + GUI_GRID_X;
			y = 2.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 19.5 * GUI_GRID_W;
			h = 9 * GUI_GRID_H;
		...
		class text_tickets: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_TICKETS;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
		...
		class text_activeCases: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_ACTIVECASES;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
			y = 1.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 19.5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		class text_titleLicences: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_VEHICLES;
			x = 0 * GUI_GRID_W + GUI_GRID_X;
			y = 12 * GUI_GRID_H + GUI_GRID_Y;
			w = 19.5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		class text_restCases: RscText {
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_OUTDATED;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
...
class kruk_slpd_info{
	...
	class controls {
		...
		{
			idc = 1201;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_DISMISSINGCASE;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
			y = 15.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 9.5 * GUI_GRID_W;
			h = 1.5 * GUI_GRID_H;
...
class kruk_slpd_vehicle_add {
	...
	class controls {
		...
		{
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_REGNUMBER;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
			y = 1.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 10 * GUI_GRID_W;
			h = 1.5 * GUI_GRID_H;
		...
		{
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_VEHDESCRIPTION;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_ADDVEH;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
			y = 0 * GUI_GRID_H + GUI_GRID_Y;
			w = 20 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		{
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_REASON;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_LEVEL;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
			y = 3.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 10 * GUI_GRID_W;
			h = 1.5 * GUI_GRID_H;
...
class kruk_slpd_criminal_add {
	...
	class controls {
		...
		{
			idc = -1;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_ADDCASE;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
			y = 0 * GUI_GRID_H + GUI_GRID_Y;
			w = 20 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		{
			idc = 1301;
			text = $STR_RPF_MODULES_SLPDCOMPUTER_FIRSTANDLASTNAME;
			x = 10 * GUI_GRID_W + GUI_GRID_X;
			y = 1.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 20 * GUI_GRID_W;
			h = 1.5 * GUI_GRID_H;
