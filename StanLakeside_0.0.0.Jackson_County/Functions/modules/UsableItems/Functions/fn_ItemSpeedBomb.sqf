 ...
 */
    ...
    if(player distance _unit > 7) exitWith {["Błąd","Jesteś za daleko!",[255,0,0,1],""] call ClientModules_Notification_fnc_showNotification; player addItem "kif_speedbomb";};
     
    ["Sukces","Podłożyłeś bombę pod pojazd!",[0,255,0,1],""] call ClientModules_Notification_fnc_showNotification;
